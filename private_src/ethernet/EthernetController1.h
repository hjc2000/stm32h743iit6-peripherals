...
namespace bsp
{
	class EthernetController1 final :
		public base::ethernet::ethernet_controller_handle
	{
	private:
		base::UsageStateManager<EthernetController1> _usage_state_manager;
		...
		{
		public:
			handle_context(EthernetController1 *self)
				: _self(self)
			{
			}

			ETH_HandleTypeDef _handle{};
			EthernetController1 *_self{};
		};
	...
	public:
		...
		void Start(base::ethernet::DuplexMode duplex_mode,
				   base::unit::Mbps const &speed) override;
